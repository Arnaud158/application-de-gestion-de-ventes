...
import sae.controller.EcranAccueilController;

import java.io.IOException;

/**
 * La classe EcranAccueilApplication illustre le fonctionnement d'une {@link Application} JavaFX.
 *
 * @author Thimothée Lepetz
 *
 * @version 0.1.0
 */
public class EcranAccueilApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        // Il faut d'abord r�cup�rer la description de la vue (au format FXML).
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../view/ecranAccueil-view.fxml"));
        Parent viewContent = fxmlLoader.load();

        // Ensuite, on la place dans une Scene...
		Scene scene = new Scene(viewContent);
        // que l'on place elle-m�me dans la fen�tre.
        stage.setScene(scene);

        // On peut ensuite donner un titre � la fenêtre.
        stage.setTitle("Gestion Ventes");
        
        // On cr�e le mod�le, et on le lie avec le contr�leur.
        EcranAccueilController controller = fxmlLoader.getController();
